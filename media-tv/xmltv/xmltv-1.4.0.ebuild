...
IUSE="ar ch-search eu-epgdata eu-xmltvse fi fi-sv fr huro is it it-dvb"
IUSE+=" na-dd na-dtv na-tvmedia pt-vodafone tr tv-check tv-combiner"
IUSE+=" tv-pick-cgi uk-tvguide zz-sdjson zz-sdjson-sqlite"
...
pkg_postinst() {
	...
	if use it-dvb; then
		...
		elog "A slightly out of date Linux::DVB is in CPAN, but not in the ::gentoo repository."
	fi
}
